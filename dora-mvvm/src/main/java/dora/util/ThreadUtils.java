...
public final class ThreadUtils {
    ...
    public static void cancel(ExecutorService executorService) {
        if (executorService instanceof ThreadPoolExecutor4Util) {
            ...
            LogUtils.e("The executorService is not ThreadUtils's pool.");
        }
    }
    ...
    private static <T> void execute(final ExecutorService pool, final Task<T> task,
        ...
        synchronized (TASK_POOL_MAP) {
            if (TASK_POOL_MAP.get(task) != null) {
                LogUtils.e("Task can only be executed once.");
                return;
            }
    ...
    static final class ThreadPoolExecutor4Util extends ThreadPoolExecutor {
        ...
        public void execute(@NonNull Runnable command) {
            ...
            try {
                ...
                LogUtils.e("This will not happen!");
            ...
            Thread t = new Thread(r, namePrefix + getAndIncrement()) {
                ...
                public void run() {
                    try {
                        ...
                        LogUtils.e("Request threw uncaught throwable, "+ t);
                    }
                }
            };
    ...
    public abstract static class SimpleTask<T> extends Task<T> {
        ...
        public void onCancel() {
            LogUtils.e("onCancel: " + Thread.currentThread());
        }
            ...
            if (isSchedule) {
                if (runner == null) {
                    ...
                    if (mTimeoutListener != null) {
                        LogUtils.w("Scheduled task doesn't support timeout.");
                    }
                } else {
    ...
    public abstract static class DoraTask<Result> extends ThreadUtils.SimpleTask<Result> {

        private Consumer<Result> mConsumer;

        public DoraTask(final Consumer<Result> consumer) {
            mConsumer = consumer;
        }
